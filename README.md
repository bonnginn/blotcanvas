...
**文章マニュアル：<https://bonnginn.github.io/blotcanvas/manual.html>**

**English version：<https://bonnginn.github.io/blotcanvas/?lang=en>**
...
初回利用時には操作の理由や読み込まれる設定範囲を説明し、慣れた利用者は補足文・注意書き・詳細説明を省略できる表示モードを検討します。主要な操作ボタンと科学的に重要な警告は残し、単なる操作説明だけを折り畳む設計とします。選択した表示モードは端末内へ保存します。
